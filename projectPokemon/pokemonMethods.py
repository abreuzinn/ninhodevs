        ...
        if self.pokeballs > 0:
            ...
            if acao == "1":
                ...
                if capturou == 1:
                    ...
                    self.pokemons += 1
                    pokemonPokemons.pokemonsCapturados.append(poke)
                else:
    ...
    if acao == "1":
        ...
        while(repetir):
            ...
            try:
                ...
                seupoke = input("\n\n")
                if seupoke == "1":
                    poke1 = pokemonPokemons.pokemonsCapturados[0]
                elif seupoke == "2":
                    poke1 = pokemonPokemons.pokemonsCapturados[1]
                elif seupoke == "3":
                    poke1 = pokemonPokemons.pokemonsCapturados[2]
                elif seupoke == "4":
                    poke1 = pokemonPokemons.pokemonsCapturados[3]
                elif seupoke == "5":
                    poke1 = pokemonPokemons.pokemonsCapturados[4]
                elif seupoke == "6":
                    poke1 = pokemonPokemons.pokemonsCapturados[5]
                elif seupoke == "0":
                    print("Você fugiu.")
                    break
                else:
    ...
    while(repetir):
        ...
        if acao == "1":
            if self.pokemons > 1:
                ...
                excluirpoke = input("\n\n")
                if excluirpoke == "1":
                    print(f"\n\nVocê excluiu o Pokémon {pokemonPokemons.pokemonsCapturados[0].species} da sua party.")
                    self.pokemons -= 1
                    pokemonPokemons.pokemonsCapturados.pop(0)
                elif excluirpoke == "2":
                    print(f"\n\nVocê excluiu o Pokémon {pokemonPokemons.pokemonsCapturados[0].species} da sua party.")
                    self.pokemons -= 1
                    pokemonPokemons.pokemonsCapturados.pop(1)
                elif excluirpoke == "3":
                    print(f"\n\nVocê excluiu o Pokémon {pokemonPokemons.pokemonsCapturados[0].species} da sua party.")
                    self.pokemons -= 1
                    pokemonPokemons.pokemonsCapturados.pop(2)
                elif excluirpoke == "4":
                    print(f"\n\nVocê excluiu o Pokémon {pokemonPokemons.pokemonsCapturados[0].species} da sua party.")
                    self.pokemons -= 1
                    pokemonPokemons.pokemonsCapturados.pop(3)
                elif excluirpoke == "5":
                    print(f"\n\nVocê excluiu o Pokémon {pokemonPokemons.pokemonsCapturados[0].species} da sua party.")
                    self.pokemons -= 1
                    pokemonPokemons.pokemonsCapturados.pop(4)
                elif excluirpoke == "6":
                    print(f"\n\nVocê excluiu o Pokémon {pokemonPokemons.pokemonsCapturados[0].species} da sua party.")
                    self.pokemons -= 1
                    pokemonPokemons.pokemonsCapturados.pop(5)
                elif excluirpoke == "0":
                    break
                else:
...
def playerPokemons():
    n = 1
    for p in pokemonPokemons.pokemonsCapturados:
